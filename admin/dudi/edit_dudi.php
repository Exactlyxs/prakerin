        ...
        <div class="container border border-dark rounded">
            ...
            <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <textarea name="alamat" class="form-control w-50" rows="5"><?php echo $row['alamat_magang'] ?></textarea>
                </div>
                <div class="form-group">
                    <label>Deskripsi Prakerin</label>
                    <textarea name="deskripsi" class="form-control w-50" rows="5"><?php echo $row['deskripsi_magang'] ?></textarea>
                </div>
                <div class="form-group">
