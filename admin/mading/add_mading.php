      ...
      <div class="container">
        <form action="add_mading_proses.php" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control w-50" name="judul" autofocus="" aria-describedby="helpId" placeholder="">
          </div>
          <div class="form-group">
            <label for="isi">Isi</label>
            <textarea class="form-control w-50" name="isi"  rows="3"></textarea>
          </div>
          <div class="form-group">
