        ...
        <div class="container border border-dark rounded">
            <div class="container">
                <form action="" method="post">
                    <h1>Hapus Pengumuman Ini?</h1>
                    <div class="form-group">
                        <label for="judul">Judul</label>
                        <input type="text" class="form-control w-50" disabled name="judul" aria-describedby="helpId"
                            value="<?php echo $row['judul'] ?>">
                    </div>
                    <div class="form-group">
                        <label for="isi">Isi</label>
                        <textarea class="form-control w-50" disabled name="isi" rows="3"><?php echo $row['isi'] ?></textarea>
                    </div>
                    <div class="form-group">
