...
<body>
    ...
    <div id="wrapper" class="animate">
        ...
        <div class="container border border-dark rounded">
            <h1>Tambah User</h1>
            <form action="add_userAction.php" method="post">
                <div class="form-group">
                    <label>Username / NISN</label>
                    <input type="text" name="username" id="" class="form-control w-50" autofocus="" aria-describedby="helpId">
                </div>
                <div class="form-group">
                    <label>Kata Sandi</label>
                    <input type="text" name="password" id="" class="form-control w-50" autofocus="" aria-describedby="helpId">
                </div>
                <div class="form-group">
                    <label>Nama</label>
                    <input type="text" name="nama" id="" class="form-control w-50" autofocus="" aria-describedby="helpId">
                </div>
                <div class="form-group">
                    <label>Jurusan</label>
                ...
                <button type="submit" name="submit" class="btn btn-md btn-primary" onclick="return confirm('Ingin Menambahkan User?');">Simpan</button>
            </form>
        </div>
