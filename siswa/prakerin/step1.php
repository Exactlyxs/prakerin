...
<div class="form-group">
    <div class="form-group">
        ...
        <select class="form-control" name="tempat-magang" id="">
            <option>PT ABADI</option>
            <option>PT Cinta Abadi</option>
            <option>PT Celalu Cetia</option>
        </select>
    </div>
</div>

<a name="selanjutnya" class="btn btn-primary" href="step2.php">selanjutnya</a>
</div>
