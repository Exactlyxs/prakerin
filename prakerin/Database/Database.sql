...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 09, 2018 at 01:42 PM
...
INSERT INTO `kelompok` (`id_kelompok`, `nisn`, `id_magang`) VALUES
(3, '0007350680', 124);
...
INSERT INTO `magang` (`id_magang`, `nama_magang`, `alamat_magang`, `deskripsi_magang`, `kapasitas_magang`) VALUES
...
INSERT INTO `user` (`nisn/nik`, `katasandi`, `nama`, `status`) VALUES
('0007350680', 'tes123', 'M. Sulthoni Sukma', '4');
...
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`nisn/nik`) REFERENCES `siswa` (`nisn`);
COMMIT;
